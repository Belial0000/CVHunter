...
<aside class="sidebar">
    ...
    ${
      CreateDataDto.photo
        ? `    <div class="avatar" style="background:url('http://localhost:5000/users/image/${CreateDataDto.photo}') no-repeat;">
    </div>`
        : `<div class="avatar" style="background:url('http://localhost:5000/users/image/asd.png') no-repeat;">
    </div>`
    }
        ...
        ${
          CreateDataDto.firstName
            ...
            <li class="sidebar--item sidebar--item-personal">
                ...
                ${CreateDataDto.firstName} ${
                CreateDataDto.lastName ? CreateDataDto.lastName : ``
              }
            </li>
        `
            : ``
        ...
        <div class="sidebar--data">
            ...
            <ul class="sidebar--list">
                ${CreateDataDto.interestsForm
                  .map((el) => {
                    return `<li class="sidebar--item sidebar--item-text sidebar--item-interest">
            ...
            <li class="section--item skills">
                ...
                <div class="skills--stars">
                    ${
                      el.level === '1'
                        ? `
                        <svg class="active" fill="#000000" height="18" viewBox="0 0 24 24" width="18"
                         xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 0h24v24H0z" fill="none"></path>
                        <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"></path>
                        <path d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    ${
                      ...
                      <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"></path>
                      <path d="M0 0h24v24H0z" fill="none"></path>
                      </svg><svg class="active" fill="#000000" height="18" viewBox="0 0 24 24" width="18"
                      xmlns="http://www.w3.org/2000/svg">
                     <path d="M0 0h24v24H0z" fill="none"></path>
                     <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"></path>
                     <path d="M0 0h24v24H0z" fill="none"></path>
